...
// @version      1.2.4
// @description  💚 进入选课页面后自动点击检索按钮; 🧡 点击“提交”时不会弹出确认提示; 💙 弹出选老师窗口中添加"快速选择"按钮，一键选择老师; 💛 添加"重复上次提交"按钮。提交失败（比如提交完显示Service unavailable）时，重新进入后点击这个按钮可以直接重复上次提交的内容，不用再重新选老师。（可跨网页、跨域名共用，支持的网址见代码里的 @match）
// @author       Barry ZZJ
// @updateURL    https://github.com/barryZZJ/CQU_class_select_helper/raw/master/CQU_class_select_helper.user.js
